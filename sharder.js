...
if(config.beta) {
	...
	setTimeout(()=>{
		const manager = new ShardingManager(`index.js`, {token: config.bot.token, respawn: true, totalShards: config.bot.shardCount, mode: "process"});
...
console.log("Please launch index.js, using internal sharding.");