...
class FurryBotLogger extends EventEmitter {
	...
	async log(msg) {
		...
		this.emit("log",{type:"log",message:msg,time:new Date().toString().split(" ")[4],file:typeof this._getCallerFile() !== "undefined" ? this.path.basename(this._getCallerFile()) : "unknown.js"});
	}
	...
	async warn(msg) {
		var color = this.chalk.yellow,
			...
			file  = typeof this._getCallerFile() !== "undefined" ? this.chalk.magenta.bold(this.path.basename(this._getCallerFile())) : this.chalk.magenta.bold("unknown.js");
		this._log(`${[undefined,null,""].includes(extra) ? "" : `[${extra}]`}[${type}][${time}][${file}]: ${m}${this.os.EOL}`);
		this.emit("log",{type:"warn",message:msg,time:new Date().toString().split(" ")[4],file:this.path.basename(this._getCallerFile())});
	}
	...
	async error(msg) {
		var color = this.chalk.red,
			...
			file  = typeof this._getCallerFile() !== "undefined" ? this.chalk.magenta.bold(this.path.basename(this._getCallerFile())) : this.chalk.magenta.bold("unknown.js");
		this._log(`${[undefined,null,""].includes(extra) ? "" : `[${extra}]`}[${type}][${time}][${file}]: ${m}${this.os.EOL}`);
		this.emit("log",{type:"error",message:msg,time:new Date().toString().split(" ")[4],file:this.path.basename(this._getCallerFile())});
	}
	...
	async debug(msg) {
		var color = this.chalk.blue,
			...
			file  = typeof this._getCallerFile() !== "undefined" ? this.chalk.magenta.bold(this.path.basename(this._getCallerFile())) : this.chalk.magenta.bold("unknown.js");
		this._log(`${[undefined,null,""].includes(extra) ? "" : `[${extra}]`}[${type}][${time}][${file}]: ${m}${this.os.EOL}`);
		this.emit("log",{type:"debug",message:msg,time:new Date().toString().split(" ")[4],file:this.path.basename(this._getCallerFile())});
	}
	...
	async info(msg) {
		var color = this.chalk.blue,
			...
			file  = typeof this._getCallerFile() !== "undefined" ? this.chalk.magenta.bold(this.path.basename(this._getCallerFile())) : this.chalk.magenta.bold("unknown.js");
		this._log(`${[undefined,null,""].includes(extra) ? "" : `[${extra}]`}[${type}][${time}][${file}]: ${m}${this.os.EOL}`);
		this.emit("log",{type:"info",message:msg,time:new Date().toString().split(" ")[4],file:this.path.basename(this._getCallerFile())});
	}
	...
	async command(msg) {
		var color = this.chalk.green,
			...
			file  = typeof this._getCallerFile() !== "undefined" ? this.chalk.magenta.bold(this.path.basename(this._getCallerFile())) : this.chalk.magenta.bold("unknown.js");
		this._log(`${[undefined,null,""].includes(extra) ? "" : `[${extra}]`}[${type}][${time}][${file}]: ${m}${this.os.EOL}`);
		this.emit("log",{type:"command",message:msg,time:new Date().toString().split(" ")[4],file:this.path.basename(this._getCallerFile())});
	}
