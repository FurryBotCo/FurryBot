module.exports = (async(self,local)=>{
    ...
    //if(!c.first().speaking.has("SPEAKING")) return self.message.reply("Nothing is playing.");
    if(c.first().dispatcher.paused) return self.message.reply("Player is already paused.");
    c.first().dispatcher.pause();
    return self.message.reply(":pause_button: **Paused**");
})