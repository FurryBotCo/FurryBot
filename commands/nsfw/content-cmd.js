module.exports = (async (self,local) => {
    ...
    if(self.os.hostname() !== "FURRYBOT-SERVER") return self.message.reply("This bot is not running on its main server, so this command is disabled!");
