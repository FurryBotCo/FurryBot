...
class ClientEvent {
	event: string;
	listener: (this: FurryBot, ...args: any[]) => any;
	...
	constructor(event: "inviteCreate" | "inviteDelete", listener: (this: FurryBot, guild: Eris.Guild, invite: Eris.GuildInvite) => void);
	constructor(event: "messageCreate", listener: (this: FurryBot, message: Eris.Message) => void);
	...
	constructor(event: string, listener: (this: FurryBot, ...args: any[]) => any) {
		this.event = event;
