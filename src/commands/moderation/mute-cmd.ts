...
export default new Command(["mute"], __filename)
	...
	.setExecutor(async function (msg, cmd) {
		...
		if ((b.member1.higher || b.member1.same) && msg.author.id !== msg.channel.guild.ownerID) return msg.reply(Language.get(msg.gConfig.settings.lang, `${cmd.lang}.noMuteOther`, [`${member.username}#${member.discriminator}`]));
