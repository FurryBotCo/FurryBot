...
export default new Command<FurryBot, UserConfig, GuildConfig>(["garfield"], __filename)
	.setBotPermissions([
		"attachFiles",
		"embedLinks"
	])
	...
	.setExecutor(async function (msg, cmd) {
		...
		const { ext, file } = await DankMemerAPI.garfield(member.avatarURL, BotFunctions.extraArgParsing(msg));
