...
export default new Command<FurryBot, UserConfig, GuildConfig>(["corporate"], __filename)
	.setBotPermissions([
		"attachFiles",
		"embedLinks"
	])
	...
	.setExecutor(async function (msg, cmd) {
		...
		const { ext, file } = await DankMemerAPI.corporate([user1.avatarURL, user2.avatarURL]);
