...
export default new Command(["quote"], __filename)
	.setBotPermissions([
		"attachFiles",
		"embedLinks"
	])
	...
	.setExecutor(async function (msg, cmd) {
		...
		const { ext, file } = await DankMemerAPI.quote(member.avatarURL, member.nick || member.username, Internal.extraArgParsing(msg));
