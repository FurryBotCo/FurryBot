...
export default new Command<FurryBot, UserConfig, GuildConfig>(["youtube"], __filename)
	.setBotPermissions([
		"attachFiles",
		"embedLinks"
	])
	...
	.setExecutor(async function (msg, cmd) {
		...
		const { ext, file } = await DankMemerAPI.youtube(member.avatarURL, member.nick || member.username, BotFunctions.extraArgParsing(msg));
