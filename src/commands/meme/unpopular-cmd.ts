...
export default new Command<FurryBot, UserConfig, GuildConfig>(["unpopular"], __filename)
	.setBotPermissions([
		"attachFiles",
		"embedLinks"
	])
	...
	.setExecutor(async function (msg, cmd) {
		...
		const { ext, file } = await DankMemerAPI.unpopular(member.avatarURL, BotFunctions.extraArgParsing(msg));
