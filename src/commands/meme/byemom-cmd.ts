...
export default new Command<FurryBot, UserConfig, GuildConfig>(["byemom"], __filename)
	.setBotPermissions([
		"attachFiles",
		"embedLinks"
	])
	...
	.setExecutor(async function (msg, cmd) {
		...
		const { ext, file } = await DankMemerAPI.byemom(member.avatarURL, member.nick || member.username, BotFunctions.extraArgParsing(msg));
