...
export default new Command(["tweet"], __filename)
	.setBotPermissions([
		"attachFiles",
		"embedLinks"
	])
	...
	.setExecutor(async function (msg, cmd) {
		...
		const { ext, file } = await DankMemerAPI.tweet(member.avatarURL, [member.nick || member.username, member.username], Internal.extraArgParsing(msg));
