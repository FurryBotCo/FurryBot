...
export default new Command<FurryBot, UserConfig, GuildConfig>(["sword"], __filename)
	.setBotPermissions([
		"attachFiles",
		"embedLinks"
	])
	...
	.setExecutor(async function (msg, cmd) {
		...
		const { ext, file } = await DankMemerAPI.sword(member.nick || member.username, BotFunctions.extraArgParsing(msg));
