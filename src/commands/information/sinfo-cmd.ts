			...
			case "server": {
				embed
					.setDescription([
						...
						`${defaultEmojis.dot} {lang:${cmd.lang}.nitroBoosts}: **${msg.channel.guild.premiumSubscriptionCount || "{lang:other.words.none$ucwords$}"}**`,
						`${defaultEmojis.dot} {lang:${cmd.lang}.boostTier}: **${msg.channel.guild.premiumTier || "{lang:other.words.none$ucwords$}"}**`,
